...
declare module "@phamhuuan/react-native-select-dropdown" {
  export type SelectDropdownProps = {
    ...
    data: Array<any>;
    /**
     * function receives selected item and its index in data array
      */
    ...
    /**
     * function receives item and index for each row in dropdown, this function shoud return a string that will be represented in each row in dropdown
     */
